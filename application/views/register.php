...
<head>
    ...
    <title>Php Ders - Kayıt Ol</title>
</head>
<body>
<div class="container">
    <h1>Kayıt Ol</h1>
    <div class="row">
        <?=form_open("registerController/register");?>
            <div class="row">
                <div class="input-field col s6">
                    <i class="material-icons prefix">account_circle</i>
                    <?=form_input(array("name" => "name", "id" => "name", "class" => "validate"));?>
                    <?=form_label("Ad - Soyad", "", array("for" => "name"));?>
                </div>
                <div class="input-field col s6">
                ...
                <div class="input-field col s6">
                    <?=form_submit(array("value" => "Kayıt Ol", "class" => "btn col s12", "type" => "submit"));?>
                </div>
            </div>
        <?=form_close();?>
    </div>
